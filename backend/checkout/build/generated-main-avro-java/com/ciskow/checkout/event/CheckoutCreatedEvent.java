 ...
 */
package com.ciskow.checkout.event;
...
public class CheckoutCreatedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -4945604796645840891L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"CheckoutCreatedEvent\",\"namespace\":\"com.ciskow.checkout.event\",\"fields\":[{\"name\":\"checkoutCode\",\"type\":[{\"type\":\"string\",\"avro.java.string\":\"String\"},\"null\"]}]}");
   ...
   */
  public static com.ciskow.checkout.event.CheckoutCreatedEvent.Builder newBuilder() {
    return new com.ciskow.checkout.event.CheckoutCreatedEvent.Builder();
  }
   ...
   * @return A new CheckoutCreatedEvent RecordBuilder
   */
  public static com.ciskow.checkout.event.CheckoutCreatedEvent.Builder newBuilder(com.ciskow.checkout.event.CheckoutCreatedEvent.Builder other) {
    if (other == null) {
      return new com.ciskow.checkout.event.CheckoutCreatedEvent.Builder();
    } else {
      return new com.ciskow.checkout.event.CheckoutCreatedEvent.Builder(other);
    }
  }
   ...
   * @return A new CheckoutCreatedEvent RecordBuilder
   */
  public static com.ciskow.checkout.event.CheckoutCreatedEvent.Builder newBuilder(com.ciskow.checkout.event.CheckoutCreatedEvent other) {
    if (other == null) {
      return new com.ciskow.checkout.event.CheckoutCreatedEvent.Builder();
    } else {
      return new com.ciskow.checkout.event.CheckoutCreatedEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CheckoutCreatedEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.ciskow.checkout.event.CheckoutCreatedEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.ciskow.checkout.event.CheckoutCreatedEvent other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.checkoutCode)) {
        this.checkoutCode = data().deepCopy(fields()[0].schema(), other.checkoutCode);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ciskow.checkout.event.CheckoutCreatedEvent.Builder setCheckoutCode(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ciskow.checkout.event.CheckoutCreatedEvent.Builder clearCheckoutCode() {
      checkoutCode = null;
